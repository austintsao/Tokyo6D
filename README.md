...
單一 HTML 檔案的東京七天六夜行程網站，不需要安裝或建置，直接用瀏覽器打開 `index.html` 就能用。
...
- DAY 3：豐洲 → 銀座 → 小石川後樂園夜間賞楓 18:00 入場（2026/11/13–11/24）→ 晚餐從簡（飯田橋周邊）
- DAY 4：原宿 → 表參道 → 午餐 Peter Luger（惠比壽）→ SHIBUYA SKY（15:00 入場看夕陽）→ 晚餐 SHIBUYA SCRAMBLE SQUARE
- DAY 5：池袋 Chiikawa Park → 午餐たかはし拉麵 → 三鷹之森吉卜力美術館（14:00 時段，週二休館）→ 晚餐牛たんの檸檬 總本店（週一公休）
